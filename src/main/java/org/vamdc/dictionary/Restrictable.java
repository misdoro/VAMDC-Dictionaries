...
AsOfDate( "Data as of this date (YYYY-MM-DD)", "Return data excluding any additions or improvements that were made after the given date (YYYY-MM-DD). This allows for reproducing an earlier query. Note that probably not all nodes support this.", "", "s", ""),
  ...
  AtomStateTotalAngMom( "Total angular moment of state core.", "", "", "i", ""),
  AtomSymbol( "Atom", "Atomic name", "", "s", ""),
  CollisionCode( "string or list of strings with 4-letter code describing process", "", "", "s", ""),
  CollisionIAEACode( "From the \"IAEA Classification of Processes\", October 2003", "", "", "s", ""),
  ...
  MoleculeStateNuclearSpinIsomer( "Nuclear spin isomer", "Nuclear spin isomer (symmetry) of a molecular state. Can take values like 'ortho','para','A','E','meta', etc.", "", "s", "(ortho|para|A|E|none)"),
  MoleculeStoichiometricFormula( "Molecular stoichiometric formula", "Molecular stoichiometric formula", "", "s", ""),
  NonRadTranEnergy( "", "", "", "f", ""),
  NonRadTranProbability( "", "", "", "f", ""),
  NonRadTranWidth( "", "", "", "f", ""),
  ...
  RadTransProbabilityIdealisedIntensity( "", "", "", "f", ""),
  ...
  RadTransProbabilityLog10WeightedOscillatorStrength( "", "", "", "f", ""),
  RadTransProbabilityOscillatorStrength( "", "", "", "f", ""),
  RadTransProbabilityWeightedOscillatorStrength( "", "", "", "f", ""),
